...
module.exports = {
    ...
    methods: {
        ...
        encrypt({ ctx = null, object = null } = {}) {
            if (!ctx || !object) return object;
            return ctx.call(`${ this.services.groups }.encryptValues`, { data: object });
        },

        decrypt({ ctx = null, object = null } = {}) {
            if (!ctx || !object) return object;
            return ctx.call(`${ this.services.groups }.decryptValues`, { data: object });
        }
