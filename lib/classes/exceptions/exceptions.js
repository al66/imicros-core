...
/** 
  ...
  */
  ...
  // exchange
  class SenderNotAllowedByReceiver extends Exception {};
  class UnvalidFetchToken extends Exception {};
  class AccessToReceiverNotGranted extends Exception {};
  class AccessToSenderNotGranted extends Exception {};
  class MessageAlreadyReceived extends Exception {};
  class FailedToNotifyReceiver extends Exception {};
  class FailedToRetrieveMessage extends Exception {};
  class FailedToRetrieveAppendix extends Exception {};
  // timer
