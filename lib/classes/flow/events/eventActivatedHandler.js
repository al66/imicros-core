...
const { EventActivated } = require("./events");
const { EventMachine } = require("./../machines/machines");

class EventActivatedHandler extends EventHandler {
    static forEvent () { return EventActivated }
...
module.exports = EventActivatedHandler;
