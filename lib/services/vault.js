...
// hash { token } => masterKey  - only local calls!
...
module.exports = {
    ...
    actions: {
         ...
         * @param {String} extension - optional: used as part of hash secret together with teh master key
         * 
    ...
    methods: {
        ...
        async startUnsealedService(ctx) {
            // create keys service
            await ctx.broker.createService({ 
                name: this.nameUnsealedService
            });
            this.logger.info("unsealed service created");
        }
