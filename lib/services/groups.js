   ...
   actions: {
      ...
      delete: {
         ...
         async handler (ctx) {
            ...
            if (decoded.payload?.type !== "deletionToken") throw new UnvalidRequest({ deletionToken: ctx.params.deletionToken, command: "delete" });
            const group = await this.groupRepository.getById({ uid: decoded.payload?.groupId });
      ...
      * @param {Boolean}   abort       abort request if not authorized (optional, default: false) 
      * 
      * @throws UnvalidToken
      *
      ...
      */
      isAuthorized: {
         ...
         params: {
            ...
            abort: { type: "boolean", optional: true, default: false }
         },
         async handler (ctx) {
            ...
            try {
               ...
               if (decoded.payload?.type === "accessToken") {
