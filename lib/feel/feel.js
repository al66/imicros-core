    ...
    actions: {
            ...
            async handler(ctx) {
                ...
                if (!ast) {
                    ...
                    if (expression?.objectName) {
                        const xml = await this.getObject({ctx: ctx, objectName: expression.objectName });
        ...
        convert: {
            ...
            async handler(ctx) {
                ...
                if (typeof ctx.params.xml === "object") xml = await this.getObject({ctx: ctx, objectName: ctx.params.xml?.objectName });
                if (ctx.params.objectName) xml = await this.getObject({ctx: ctx, objectName: ctx.params.objectName })
