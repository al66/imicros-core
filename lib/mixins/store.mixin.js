...
module.exports = (options) => { return {
    ...
    methods: {
        ...
        async getStream ({ ctx = null, objectName = null } = {}) {
            ...
            try {
                let stream = await this.broker.call(this.services.minio + ".getObject", params, opts);
                return stream;            
            } catch (err) {
        ...
        async pipeStream ({ ctx = null, objectName = null } = {}) {
            ...
            // call file service
            try {
                this.broker.call(this.services.minio + ".putObject", passThrough, opts);
                return passThrough;            
            } catch (err) {
                /* istanbul ignore next */
                {
        ...
        async putStream ({ ctx = null, objectName = null, stream = null } = {}) {
            ...
            // call file service
            try {
                let result = await this.broker.call(this.services.minio + ".putObject", stream, opts);
                return result;
            } catch (err) {
                /* istanbul ignore next */
                {
        ...
        async removeObject ({ ctx = null, objectName = null } = {}) {
            ...
            try {
                let result = await this.broker.call(this.services.minio + ".removeObject", params, opts);
                return result;
            } catch (err) {
                /* istanbul ignore next */
                {
    ...
    created() {
        ...
        // set actions
        if (this.services) {
            this.services.minio = this.settings?.services?.minio ?? "minio";
        } else {
            this.services = {
                minio: this.settings?.services?.minio ?? "minio"
            };        
        }
